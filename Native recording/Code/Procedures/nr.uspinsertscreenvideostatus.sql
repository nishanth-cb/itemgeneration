-- PROCEDURE: nr.uspinsertscreenvideostatus(bigint, character varying, character varying, character varying, timestamp without time zone, timestamp without time zone, character varying, integer, numeric, integer, integer, character varying, numeric, integer, integer, integer, character varying, numeric, character varying, numeric, character varying, integer, character varying, integer, character varying, integer, integer, character varying, integer, numeric, integer, numeric, numeric, numeric, integer, integer, character varying, integer, character varying, character varying, character varying, character varying, character varying, character varying, character varying)

-- DROP PROCEDURE IF EXISTS nr.uspinsertscreenvideostatus(bigint, character varying, character varying, character varying, timestamp without time zone, timestamp without time zone, character varying, integer, numeric, integer, integer, character varying, numeric, integer, integer, integer, character varying, numeric, character varying, numeric, character varying, integer, character varying, integer, character varying, integer, integer, character varying, integer, numeric, integer, numeric, numeric, numeric, integer, integer, character varying, integer, character varying, character varying, character varying, character varying, character varying, character varying, character varying);

CREATE OR REPLACE PROCEDURE nr.uspinsertscreenvideostatus(
	IN par_videostatusid bigint DEFAULT 0,
	...
	IN par_facingmode character varying DEFAULT NULL::character varying,
	IN par_framerate integer DEFAULT NULL::integer,
	IN par_groupid character varying DEFAULT NULL::character varying,
...
/* Description: */
/* ;12-02-2024;Nishanth added VideoStatusID column */
/* ============================================================ */
...
END;
$BODY$;
ALTER PROCEDURE nr.uspinsertscreenvideostatus(bigint, character varying, character varying, character varying, timestamp without time zone, timestamp without time zone, character varying, integer, numeric, integer, integer, character varying, numeric, integer, integer, integer, character varying, numeric, character varying, numeric, character varying, integer, character varying, integer, character varying, integer, integer, character varying, integer, numeric, integer, numeric, numeric, numeric, integer, integer, character varying, integer, character varying, character varying, character varying, character varying, character varying, character varying, character varying)
    OWNER TO postgres;
